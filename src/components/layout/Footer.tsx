...
export function Footer() {
  ...
  return (
    <footer className="relative bg-slate-50/85 backdrop-blur-md text-slate-600 pt-12 pb-6 border-t border-slate-200/70 overflow-hidden">
      {/* Subtle ambient light leaks */}
      <div className="absolute top-0 left-1/4 w-96 h-96 bg-blue-100/40 rounded-full blur-[120px] pointer-events-none -translate-y-1/2" />
      <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-indigo-100/40 rounded-full blur-[120px] pointer-events-none translate-y-1/2" />
      ...
      <div className="container mx-auto px-6 max-w-6xl relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start mb-10">
          ...
          <div className="lg:col-span-5 flex flex-col items-start space-y-4">
            <div className="px-2 py-1 bg-white rounded-lg shadow-sm border border-slate-200/50 inline-block">
              <Image
            ...
            <div className="flex flex-col space-y-2 pt-2 text-xs">
              ...
              <div className="flex items-center gap-2.5 text-slate-600 font-medium">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <a href="tel:+918817147082" className="hover:text-blue-600 transition-colors">+91 8817147082</a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-3">
            ...
            <ul className="grid grid-cols-2 gap-x-4 gap-y-2 text-xs font-medium">
              {[
                ...
                <li key={idx}>
                  <Link href={link.href} className="text-slate-500 hover:text-blue-600 transition-colors block py-0.5">
                    {link.label}
                  </Link>
                </li>
              ))}
          ...
          <div className="lg:col-span-4">
            ...
            {/* Location Tabs (iOS-style Segmented Control) */}
            <div className="flex flex-wrap gap-1 mb-3 bg-slate-200/50 p-1 rounded-lg border border-slate-200/30">
