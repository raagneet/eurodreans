    ...
    <section className="relative min-h-[85vh] flex flex-col justify-center py-12 bg-slate-50 overflow-hidden">
      ...
      <div className="container mx-auto px-6 max-w-7xl relative z-10 flex flex-col lg:flex-row items-center gap-12 lg:gap-8">
        ...
        <div className="lg:w-[45%] w-full relative min-h-[600px] hidden lg:block">
           ...
           >
              <Image src="/images/italy/italy_library_students.png" fill className="object-cover" alt="Students in Italian Library" sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" />
           </motion.div>
           ...
           >
              <Image src="/images/italy_education_cinematic.png" fill className="object-cover" alt="Cinematic Italy Education" sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" />
           </motion.div>
           ...
           >
              <Image src="/images/italy/student_life_italy.png" fill className="object-cover" alt="Student Life in Italy" sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" />
           </motion.div>
        </div>
      </div>
    </section>
